...
var jumpSound,dieSound,checkpointSound,jump;
var score;
...
ground_image=loadImage("Background.png");
  girl_running=loadAnimation("Run (1).png","Run (2).png","Run (3).png","Run (4).png","Run (5).png","Run (6).png","Run (7).png","Run (8).png","Run (9).png","Run (10).png");
  ...
  dieSound = loadSound("mixkit-falling-hit-757.wav")
  jump = loadSound("mixkit-game-blood-pop-slide-2363.wav")
...
ground.scale=1.4;
  ...
  girl.addAnimation("girl_runnin",girl_running);
...
zombie.collide(invisible_ground); 
 ...
 if((keyDown("space")&& girl.y  >= 400)) {
  ...
  text("PROTECT THE GIRL FROM THE ZOMBIE ", 150,20);
  text("SURVIVE AS LONG YOU CAN ", 200,50);
}
...
function reset(){
  ...
  gameOver.visible=false;
  restart.visible=false;
  girl.changeAnimation("girl_runnin",girl_running);
